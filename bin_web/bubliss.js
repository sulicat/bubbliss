...
var ASM_CONSTS = {
  114776: () => { if (document.fullscreenElement) return 1; },  
 114822: () => { return document.getElementById('canvas').width; },  
 114874: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114942: () => { document.exitFullscreen(); },  
 114969: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 115042: () => { if (document.fullscreenElement) return 1; },  
 115088: () => { return document.getElementById('canvas').width; },  
 115140: () => { return screen.width; },  
 115165: () => { document.exitFullscreen(); },  
 115192: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 115325: () => { return window.innerWidth; },  
 115351: () => { return window.innerHeight; },  
 115378: () => { if (document.fullscreenElement) return 1; },  
 115424: () => { return document.getElementById('canvas').width; },  
 115476: () => { return parseInt(document.getElementById('canvas').style.width); },  
 115544: () => { if (document.fullscreenElement) return 1; },  
 115590: () => { return document.getElementById('canvas').width; },  
 115642: () => { return screen.width; },  
 115667: () => { return window.innerWidth; },  
 115693: () => { return window.innerHeight; },  
 115720: () => { if (document.fullscreenElement) return 1; },  
 115766: () => { return document.getElementById('canvas').width; },  
 115818: () => { return screen.width; },  
 115843: () => { document.exitFullscreen(); },  
 115870: () => { if (document.fullscreenElement) return 1; },  
 115916: () => { return document.getElementById('canvas').width; },  
 115968: () => { return parseInt(document.getElementById('canvas').style.width); },  
 116036: () => { document.exitFullscreen(); },  
 116063: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 116121: () => { return screen.width; },  
 116146: () => { return screen.height; },  
 116172: () => { return window.screenX; },  
 116199: () => { return window.screenY; },  
 116226: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 116279: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 116350: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 116407: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 116663: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 116734: () => { if (document.fullscreenElement) return 1; },  
 116780: () => { return window.innerWidth; },  
 116806: () => { return window.innerHeight; },  
 116833: () => { if (document.pointerLockElement) return 1; }
};
